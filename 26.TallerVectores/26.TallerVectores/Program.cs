...
namespace _26.TallerVectores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            /*3.Crea un algoritmo que llene un vector[20] con números 
             * enteros positivos aleatorios entre 0 y 50.Luego le debe 
             * pedir al usuario un número para buscar en el vector. 
             * Si encuentra el número, se debe mostrar en pantalla: 
             * la posición en que se encuentra el número, y el vector 
             * resaltando el número en un color diferente.Si no se 
             * encuentra el número, se debe devolver y mostrar -1
            ...
            numerosPositivos = random.Next(0, 51);
            ...
            if (posicion != -1)
            {
                Console.WriteLine($"El número {numeroBuscado} se encuentra en la posición {posicion} del vector.");
                for (int i = 0; i < vector.Length; i++)
                {
                    if (vector[i] == numeroBuscado)
                    {
             ...
             * Llenar la primera mitad del vector, con los números menores al número 
             * almacenado en la posición de la mitad. 
             * Llenar la parte inicial del vector, con los números 
             * menores al número almacenado en la posición de la mitad.
             * Llenar la parte final del vector, con los números mayores 
             * al número almacenado en la posición de la mitad. 
